...
CREATE OR REPLACE PROCEDURE FIDE_PROLEARN_FINAL_PROF.OBTENER_CURSOS_USUARIO (
...
CREATE OR REPLACE PROCEDURE FIDE_PROLEARN_FINAL_PROF.INSERTAR_RELACION_USUARIO_CURSO (
