...
CREATE TABLE FIDE_PROLEARN_FINAL_PROF.FIDE_USUARIOS_TB (
    USUARIOS_TB_ID_USUARIOS_PK NUMBER DEFAULT FIDE_PROLEARN_FINAL_PROF.ID_USUARIO_SEQ.NEXTVAL PRIMARY KEY,
...
CREATE TABLE FIDE_PROLEARN_FINAL_PROF.FIDE_USUARIO_ROL_TB (
    USUARIO_ID INT,
    ROL_ID INT,
    FOREIGN KEY (USUARIO_ID) REFERENCES FIDE_PROLEARN_FINAL_PROF.FIDE_USUARIOS_TB(USUARIOS_TB_ID_USUARIOS_PK),
...
CREATE TABLE FIDE_PROLEARN_FINAL_PROF.FIDE_CATEGORIAS_TB (
  CATEGORIAS_TB_ID_CATEGORIA_PK NUMBER DEFAULT FIDE_PROLEARN_FINAL_PROF.ID_CATEGORIA_SEQ.NEXTVAL PRIMARY KEY,
...
CREATE TABLE FIDE_PROLEARN_FINAL_PROF.FIDE_CAPITULO_PADRE_TB (
  CAPITULO_PADRE_TB_ID_CAPITULO_PK NUMBER DEFAULT FIDE_PROLEARN_FINAL_PROF.ID_CAPITULO_PADRE_SEQ.NEXTVAL PRIMARY KEY,
...
CREATE TABLE FIDE_PROLEARN_FINAL_PROF.FIDE_CAPITULO_HIJO_TB (
  CAPITULO_HIJO_TB_ID_CAPITULO_PK NUMBER DEFAULT FIDE_PROLEARN_FINAL_PROF.ID_CAPITULO_HIJO_SEQ.NEXTVAL PRIMARY KEY,
  ID_CAPITULO_PADRE INT NOT NULL,
  NOMBRE_CAPITULO VARCHAR2(255) NOT NULL,
  VIDEO_CAPITULO VARCHAR2(1024),
  NUMERO_CAPITULO INT NOT NULL,
  FOREIGN KEY (ID_CAPITULO_PADRE) REFERENCES FIDE_PROLEARN_FINAL_PROF.FIDE_CAPITULO_PADRE_TB(CAPITULO_PADRE_TB_ID_CAPITULO_PK)
);
...
CREATE TABLE FIDE_PROLEARN_FINAL_PROF.FIDE_CURSOS_TB (
  CURSOS_TB_ID_CURSO_PK NUMBER DEFAULT FIDE_PROLEARN_FINAL_PROF.ID_CURSO_SEQ.NEXTVAL PRIMARY KEY,
  ...
  FOREIGN KEY (CATEGORIA_CURSO) REFERENCES FIDE_PROLEARN_FINAL_PROF.FIDE_CATEGORIAS_TB(CATEGORIAS_TB_ID_CATEGORIA_PK)
);
...
CREATE TABLE FIDE_PROLEARN_FINAL_PROF.FIDE_CAPITULO_X_CURSO_TB (
  CAPITULO_X_CURSO_TB_ID_PK NUMBER DEFAULT FIDE_PROLEARN_FINAL_PROF.ID_CAPITULO_X_CURSO_SEQ.NEXTVAL PRIMARY KEY,
  ID_CURSO INT NOT NULL,
  ID_CAPITULO INT NOT NULL,
  FOREIGN KEY (ID_CURSO) REFERENCES FIDE_PROLEARN_FINAL_PROF.FIDE_CURSOS_TB(CURSOS_TB_ID_CURSO_PK),
  FOREIGN KEY (ID_CAPITULO) REFERENCES FIDE_PROLEARN_FINAL_PROF.FIDE_CAPITULO_HIJO_TB(CAPITULO_HIJO_TB_ID_CAPITULO_PK) ON DELETE CASCADE
);
...
INSERT INTO FIDE_PROLEARN_FINAL_PROF.FIDE_CAPITULO_PADRE_TB (NOMBRE_CAPITULO, NUMERO_CAPITULO)
...
INSERT INTO FIDE_PROLEARN_FINAL_PROF.FIDE_CAPITULO_HIJO_TB (ID_CAPITULO_PADRE, NOMBRE_CAPITULO, VIDEO_CAPITULO, NUMERO_CAPITULO) VALUES
