...
CREATE SEQUENCE PROLEARN.ID_USUARIO_SEQ
START WITH 1
INCREMENT BY 1
NOCACHE;

CREATE TABLE PROLEARN.FIDE_USUARIOS_TB (
    USUARIOS_TB_ID_USUARIOS_PK NUMBER DEFAULT PROLEARN.ID_USUARIO_SEQ.NEXTVAL PRIMARY KEY,
    V_NOMBRE VARCHAR2(250) NOT NULL,
    V_APELLIDOS VARCHAR2(250) NOT NULL,
    V_EMAIL VARCHAR2(25) NOT NULL,
    V_PASSWORD VARCHAR2(512) NOT NULL 
);

CREATE SEQUENCE PROLEARN.ID_ROL_SEQ
START WITH 1
INCREMENT BY 1
NOCACHE;

CREATE TABLE PROLEARN.FIDE_ROL_TB (
    ROL_TB_ID_ROL_PK NUMBER DEFAULT PROLEARN.ID_ROL_SEQ.NEXTVAL PRIMARY KEY,
    V_NOMBRE VARCHAR2(255)
);

CREATE TABLE PROLEARN.FIDE_USUARIO_ROL_TB (
    V_USUARIO_ID INT,
    V_ROL_ID INT,
    FOREIGN KEY (V_USUARIO_ID) REFERENCES PROLEARN.FIDE_USUARIOS_TB(USUARIOS_TB_ID_USUARIOS_PK),
    FOREIGN KEY (V_ROL_ID) REFERENCES PROLEARN.FIDE_ROL_TB(ROL_TB_ID_ROL_PK)
);

CREATE SEQUENCE PROLEARN.ID_CATEGORIA_SEQ
START WITH 1
INCREMENT BY 1
NOCACHE;

CREATE TABLE PROLEARN.FIDE_CATEGORIAS_TB (
  CATEGORIAS_TB_ID_CATEGORIA_PK NUMBER DEFAULT PROLEARN.ID_CATEGORIA_SEQ.NEXTVAL PRIMARY KEY,
  V_NOMBRE_CATEGORIA VARCHAR2(255) NOT NULL
);

CREATE SEQUENCE PROLEARN.ID_CAPITULO_PADRE_SEQ
START WITH 1
INCREMENT BY 1
NOCACHE;

CREATE TABLE PROLEARN.FIDE_CAPITULO_PADRE_TB (
  CAPITULO_PADRE_TB_ID_CAPITULO_PK NUMBER DEFAULT PROLEARN.ID_CAPITULO_PADRE_SEQ.NEXTVAL PRIMARY KEY,
  V_NOMBRE_CAPITULO VARCHAR2(255) NOT NULL,
  V_NUMERO_CAPITULO INT NOT NULL
);

CREATE SEQUENCE PROLEARN.ID_CAPITULO_HIJO_SEQ
START WITH 1
INCREMENT BY 1
NOCACHE;

CREATE TABLE PROLEARN.FIDE_CAPITULO_HIJO_TB (
  CAPITULO_HIJO_TB_ID_CAPITULO_PK NUMBER DEFAULT PROLEARN.ID_CAPITULO_HIJO_SEQ.NEXTVAL PRIMARY KEY,
  V_ID_CAPITULO_PADRE INT NOT NULL,
  V_NOMBRE_CAPITULO VARCHAR2(255) NOT NULL,
  V_VIDEO_CAPITULO VARCHAR2(1024),
  V_NUMERO_CAPITULO INT NOT NULL,
  FOREIGN KEY (V_ID_CAPITULO_PADRE) REFERENCES PROLEARN.FIDE_CAPITULO_PADRE_TB(CAPITULO_PADRE_TB_ID_CAPITULO_PK)
);

CREATE SEQUENCE PROLEARN.ID_CURSO_SEQ
START WITH 1
INCREMENT BY 1
NOCACHE;

CREATE TABLE PROLEARN.FIDE_CURSOS_TB (
  CURSOS_TB_ID_CURSO_PK NUMBER DEFAULT PROLEARN.ID_CURSO_SEQ.NEXTVAL PRIMARY KEY,
  V_NOMBRE_CURSO VARCHAR2(250) NOT NULL,
  V_DESCRP_CURSO VARCHAR2(1000),
  V_ESTADO_CURSO NUMBER(1),
  V_THUMBNAIL_CURSO VARCHAR2(1024),
  V_CATEGORIA_CURSO INT NOT NULL,
  FOREIGN KEY (V_CATEGORIA_CURSO) REFERENCES PROLEARN.FIDE_CATEGORIAS_TB(CATEGORIAS_TB_ID_CATEGORIA_PK)
);

CREATE SEQUENCE PROLEARN.ID_CAPITULO_X_CURSO_SEQ
START WITH 1
INCREMENT BY 1
NOCACHE;

CREATE TABLE PROLEARN.FIDE_CAPITULO_X_CURSO_TB (
  CAPITULO_X_CURSO_TB_ID_PK NUMBER DEFAULT PROLEARN.ID_CAPITULO_X_CURSO_SEQ.NEXTVAL PRIMARY KEY,
  V_ID_CURSO INT NOT NULL,
  V_ID_CAPITULO INT NOT NULL,
  FOREIGN KEY (V_ID_CURSO) REFERENCES PROLEARN.FIDE_CURSOS_TB(CURSOS_TB_ID_CURSO_PK),
  FOREIGN KEY (V_ID_CAPITULO) REFERENCES PROLEARN.FIDE_CAPITULO_HIJO_TB(CAPITULO_HIJO_TB_ID_CAPITULO_PK) ON DELETE CASCADE
);

/*insercion de datos*/

INSERT INTO PROLEARN.FIDE_ROL_TB (V_NOMBRE) VALUES ('ROLE_USER');
INSERT INTO PROLEARN.FIDE_ROL_TB (V_NOMBRE) VALUES ('ROLE_ADMIN');


INSERT INTO PROLEARN.FIDE_USUARIOS_TB (V_NOMBRE, V_APELLIDOS, V_EMAIL, V_PASSWORD)
...
INSERT INTO PROLEARN.FIDE_USUARIO_ROL_TB (V_USUARIO_ID, V_ROL_ID)
VALUES (1, 1);
INSERT INTO PROLEARN.FIDE_USUARIO_ROL_TB (V_USUARIO_ID, V_ROL_ID)
VALUES (2, 2);


INSERT INTO PROLEARN.FIDE_CATEGORIAS_TB (V_NOMBRE_CATEGORIA) VALUES  ('Diseño');
INSERT INTO PROLEARN.FIDE_CATEGORIAS_TB (V_NOMBRE_CATEGORIA) VALUES  ('Programacion');
INSERT INTO PROLEARN.FIDE_CATEGORIAS_TB (V_NOMBRE_CATEGORIA) VALUES  ('Idiomas');
COMMIT;


/*Inserts de Padres Python */

INSERT INTO PROLEARN.FIDE_CAPITULO_PADRE_TB (V_NOMBRE_CAPITULO, V_NUMERO_CAPITULO)
...
INSERT INTO PROLEARN.FIDE_CAPITULO_HIJO_TB (V_ID_CAPITULO_PADRE, V_NOMBRE_CAPITULO, V_VIDEO_CAPITULO, V_NUMERO_CAPITULO) VALUES
...
INSERT INTO PROLEARN.FIDE_CURSOS_TB (V_NOMBRE_CURSO, V_DESCRP_CURSO, V_ESTADO_CURSO, V_THUMBNAIL_CURSO, V_CATEGORIA_CURSO) VALUES
...
INSERT INTO PROLEARN.FIDE_CAPITULO_X_CURSO_TB (V_ID_CURSO, V_ID_CAPITULO)
VALUES (1, 1);
