...
---Se busca el ID de tipo cursos y facturas
...
CREATE OR REPLACE PROCEDURE FIDE_PROLEARN_FINAL_PROF.FACTURA_GETALL_PUBLICO_SP(
  P_ID_FACTURAS OUT SYS_REFCURSOR
) AS
BEGIN
  OPEN P_ID_FACTURAS FOR
