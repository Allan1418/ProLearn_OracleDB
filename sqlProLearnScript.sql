...
INSERT INTO PROLEARN.capitulo_padre (nombre_capitulo, numero_capitulo)
...
,1, 'https://img.freepik.com/vector-gratis/fondo-libro-ingles-dibujado-mano_23-2149483336.jpg?size=626&ext=jpg&ga=GA1.1.2008272138.1720915200&semt=ais_user', 3);
COMMIT;


/*Inserts de capitulo_x_curso Python */

INSERT INTO PROLEARN.capitulo_x_curso (id_curso, id_capitulo)
VALUES (1, 1);
...
BEGIN
    INSERT INTO PROLEARN.categorias (nombre_categoria)
...
-- Procedimiento para crear un capítulo padre
CREATE OR REPLACE PROCEDURE sp_create_parent_chapter(
    p_nombre_capitulo IN VARCHAR2,
    p_numero_capitulo IN INT
) IS
BEGIN
    INSERT INTO PROLEARN.capitulo_padre (nombre_capitulo, numero_capitulo)
    VALUES (p_nombre_capitulo, p_numero_capitulo);
    COMMIT;
END;
/

-- Procedimiento para crear un capítulo hijo
CREATE OR REPLACE PROCEDURE sp_create_child_chapter(
...
BEGIN
    INSERT INTO PROLEARN.capitulo_hijo (id_capitulo_padre, nombre_capitulo, video_capitulo, numero_capitulo)
    VALUES (p_id_capitulo_padre, p_nombre_capitulo, p_video_capitulo, p_numero_capitulo);
    COMMIT;
END;
/

-- Procedimiento para asignar un capítulo a un curso
CREATE OR REPLACE PROCEDURE sp_assign_chapter_to_course(
    p_id_curso IN INT,
    p_id_capitulo IN INT
) IS
BEGIN
    INSERT INTO PROLEARN.capitulo_x_curso (id_curso, id_capitulo)
    VALUES (p_id_curso, p_id_capitulo);
    COMMIT;
END;
/
...
BEGIN
    DELETE FROM PROLEARN.usuarios WHERE id = p_usuario_id;
    COMMIT;
END;
/
...
/*  
drop table capitulo_x_curso;
drop table capitulo_hijo;
drop table capitulo_padre;
drop table cursos;
